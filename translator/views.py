...
def translation_view(request, pk): 
    ...
    if request.method == 'GET': 
        ...
        target_language = project.target_language.language_code
        ...
        if article_intro:
            ...
            for sentence in result:
                translated_sentence = ''
                try:
                    translated_sentence = GoogleTranslator(source='auto', target=target_language).translate(sentence.original_sentence)
